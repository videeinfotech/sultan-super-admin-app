    ...
    <div className="flex-1 flex flex-col px-6 bg-white dark:bg-background-dark overflow-y-auto">
      ...
      <div className="space-y-4">
        <div className="flex flex-col w-full">
          ...
          <input 
            className="form-input flex w-full rounded-lg text-[#111318] dark:text-white focus:outline-0 focus:ring-2 focus:ring-primary/50 border border-[#dbdfe6] dark:border-gray-700 bg-white dark:bg-gray-800 h-14 placeholder:text-[#616f89] p-[15px] text-base font-normal" 
        ...
        <div className="flex flex-col w-full">
          ...
          <div className="flex w-full items-stretch rounded-lg">
            <input 
              className="form-input flex w-full min-w-0 flex-1 rounded-lg rounded-r-none border-r-0 text-[#111318] dark:text-white focus:outline-0 focus:ring-2 focus:ring-primary/50 border border-[#dbdfe6] dark:border-gray-700 bg-white dark:bg-gray-800 h-14 placeholder:text-[#616f89] p-[15px]" 
        ...
        <div className="pt-6 space-y-3">
          <button 
            onClick={() => onLogin('super')}
            className="flex w-full cursor-pointer items-center justify-center rounded-xl h-14 px-5 bg-primary text-white text-base font-bold shadow-lg shadow-primary/20 hover:bg-primary/90 transition-colors"
          >
            Login as Super Admin
          </button>
          <button 
            onClick={() => onLogin('store')}
            className="flex w-full cursor-pointer items-center justify-center rounded-xl h-14 px-5 border border-primary text-primary text-base font-bold hover:bg-primary/5 transition-colors"
          >
