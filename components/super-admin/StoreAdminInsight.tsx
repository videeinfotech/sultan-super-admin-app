  ...
  return (
    <div className="flex-1 flex flex-col bg-white dark:bg-background-dark overflow-y-auto pb-20">
      ...
      <main>
        ...
        <div className="px-4 py-2">
          <div className="flex justify-between bg-background-light dark:bg-gray-800/50 rounded-2xl p-2">
            <div className="flex flex-col items-center gap-1 flex-1 py-2 cursor-pointer" onClick={() => onNavigate('store-stock')}>
              <div className="bg-white dark:bg-background-dark p-2.5 rounded-full shadow-sm text-primary">
                <span className="material-symbols-outlined text-[20px]">inventory</span>
              </div>
              <p className="text-[10px] font-bold uppercase tracking-wider mt-1">Stock</p>
            </div>
            <div className="flex flex-col items-center gap-1 flex-1 py-2 cursor-pointer" onClick={() => onNavigate('store-staff')}>
              <div className="bg-white dark:bg-background-dark p-2.5 rounded-full shadow-sm text-primary">
                <span className="material-symbols-outlined text-[20px]">group</span>
              </div>
              <p className="text-[10px] font-bold uppercase tracking-wider mt-1">Staff</p>
            </div>
            <div className="flex flex-col items-center gap-1 flex-1 py-2 cursor-pointer" onClick={() => onNavigate('store-settings')}>
              <div className="bg-white dark:bg-background-dark p-2.5 rounded-full shadow-sm text-primary">
                <span className="material-symbols-outlined text-[20px]">settings</span>
              </div>
              <p className="text-[10px] font-bold uppercase tracking-wider mt-1">Setup</p>
            </div>
          </div>
        </div>
        ...
        <div className="px-4 pt-4">
          ...
          <div className="bg-background-light dark:bg-gray-800/50 rounded-2xl p-4">
            <div className="flex justify-between items-center mb-4">
              ...
              <span className="text-xs font-bold text-primary px-3 py-1 bg-white dark:bg-background-dark rounded-lg cursor-pointer" onClick={() => onNavigate('store-stock')}>View Stock</span>
            </div>
      ...
      <nav className="fixed bottom-0 left-0 right-0 max-w-[430px] mx-auto h-20 bg-white dark:bg-background-dark border-t dark:border-gray-800 flex items-center justify-around z-50">
        <div className="flex flex-col items-center text-primary cursor-pointer" onClick={() => onNavigate('store-insight', storeId || '1')}>
